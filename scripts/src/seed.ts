...
async function seed() {
  ...
  const products = [
    ...
    // Food
    {
      ...
      imageUrl: "https://images.unsplash.com/photo-1581929397046-c4c1a8bc59df?w=600&q=80",
      images: ["https://images.unsplash.com/photo-1581929397046-c4c1a8bc59df?w=600&q=80"],
      rating: "4.9",
      reviewCount: 678,
      stock: 500,
      isFeatured: true,
