...
export const getFavorites = async (
  ...
  return customFetch<Product[]>(getGetFavoritesUrl(params), {
    ...options,
    method: "GET",
  });
};
...
export const getRemoveFavoriteUrl = (
  ...
  return stringifiedParams.length > 0
    ? `/api/favorites/${productId}?${stringifiedParams}`
...
export const removeFavorite = async (
  ...
  return customFetch<SuccessResponse>(getRemoveFavoriteUrl(productId, params), {
    ...options,
    method: "DELETE",
  });
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { productId: number; params: RemoveFavoriteParams },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return removeFavorite(productId, params, requestOptions);
  };
 ...
 */
export const getGetCitiesByRegionUrl = (id: number) => {
...
export const getCitiesByRegion = async (
  ...
  return customFetch<City[]>(getGetCitiesByRegionUrl(id), {
    ...options,
    method: "GET",
  });
};

export const getGetCitiesByRegionQueryKey = (id: number) => {
...
>(
  ...
  const queryKey = queryOptions?.queryKey ?? getGetCitiesByRegionQueryKey(id);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getCitiesByRegion>>
  > = ({ signal }) => getCitiesByRegion(id, { signal, ...requestOptions });
...
>(
  ...
  const queryOptions = getGetCitiesByRegionQueryOptions(id, options);
