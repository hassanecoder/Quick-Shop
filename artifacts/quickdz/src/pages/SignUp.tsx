  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md bg-card rounded-[2.5rem] p-8 sm:p-12 shadow-2xl border border-border">
        ...
        <p className="text-center text-muted-foreground mb-8">Join the QuickDz community</p>

        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
          <div className="space-y-2">
            <label className="text-sm font-semibold">{t('Full Name')}</label>
            <Input type="text" placeholder="John Doe" className="h-14 rounded-xl bg-secondary border-transparent focus:bg-background" />
          </div>
          <div className="space-y-2">
